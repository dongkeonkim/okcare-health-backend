---
name: verify-backend
description: 오케어 백엔드 테스트와 검증 작업을 기능 계약, 테스트 전략, 회귀 입력과 결과 보고 기준으로 라우팅한다. 단위, MVC 슬라이스, Testcontainers 통합, fixture 회귀, E2E, 전체 빌드, Docker Compose 스모크, 실패 분석과 검증 누락 점검에 사용한다.
---
